...
deliverable. Crash, kill -9, machine reboot — none of it matters.

Run:
    python examples/07_resume.py

Submit some items in a worker, then ^C the producer mid-run. Re-run:
already-done items are skipped, only pending ones are re-published.
