...
preserved as the new template, so fixing-in-place is easy.

Run:
    python examples/04_validation.py

A worker that submits with `part_of_speech=""` will see:
    === PREVIOUS SUBMISSION REJECTED ===
    part_of_speech is required
... and a fresh `bridge get` will print the corrected prompt with the
prior draft intact.
"""
